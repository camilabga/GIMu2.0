...
void loop() {
  ...
  if(S[0]=='r'){
      int velDir = map((int)S[1],100,200,200 /* velocidade para seguir em frente como se n houvesse amanha (ou parede)*/,255);
      int velEsq = 200 /* velocidade para seguir em frente como se n houvesse amanha (ou parede)*/;
